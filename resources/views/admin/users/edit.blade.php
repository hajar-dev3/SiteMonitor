        ...
        <div class="overflow-hidden rounded-3xl border border-[#E4DDD4] bg-white shadow-[0_10px_35px_rgba(36,60,57,0.06)]">
            ...
            <div class="border-b border-[#EDF1EF] bg-[#FAFBFA] px-7 py-6">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#806D89]/10 text-[#806D89]">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-[#89978F]">
                            ...
                            <span class="font-bold text-[#243C39]">
                                {{ $user->name }}
                            </span>
            ...
            >
                ...
                <div class="mt-8 rounded-2xl border border-[#806D89]/15 bg-[#806D89]/5 p-5">

                    <div class="flex gap-3">

                        <div class="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-[#806D89]/10 text-[#806D89]">
                            i
                        </div>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm leading-6 text-[#71817B]">
                                Leave the password fields empty if you want to
                ...
                <div class="mt-8 flex flex-col-reverse gap-3 border-t border-[#EDF1EF] pt-7 sm:flex-row sm:justify-end">
                    ...
                    <button
                        type="submit"
                        class="inline-flex items-center justify-center gap-2 rounded-xl bg-[#806D89] px-6 py-3.5 text-sm font-bold text-white shadow-sm transition hover:opacity-90 hover:shadow-md focus:outline-none focus:ring-4 focus:ring-[#806D89]/20"
                    >
