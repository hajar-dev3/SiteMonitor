        ...
        <div class="relative z-10 flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-[#718582]">
                    Update your website information and monitoring settings.
                </p>
    ...
    <div class="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div class="mb-7">
            ...
            <h1 class="mt-1 text-3xl font-black tracking-tight text-[#243c39] sm:text-4xl">
                Update your monitored website
            </h1>

            <p class="mt-2 max-w-2xl text-sm leading-6 text-[#7b8985]">
                Modify your website information and choose how SiteMonitor should monitor its availability.
            </p>
        ...
        <div class="overflow-hidden rounded-3xl border border-[#dddcd5] bg-white shadow-sm">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-[#808d89]">
                            Update the information used to monitor your website.
                        </p>
            ...
            >
                ...
                <div class="mt-9 border-t border-[#eeeDE7] pt-8">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-[#858f8b]">
                            Update how frequently SiteMonitor checks your website.
                        </p>
                    ...
                    <div class="max-w-xl">
                        ...
                        <div class="relative mt-3">
                            ...
                            >
                                ...
                                <option value="1" {{ old('monitoring_interval', $site->monitoring_interval) == 1 ? 'selected' : '' }}>
                                    Every 1 minute
                                </option>

                                <option value="5" {{ old('monitoring_interval', $site->monitoring_interval) == 5 ? 'selected' : '' }}>
                                    Every 5 minutes
                                </option>

                                <option value="10" {{ old('monitoring_interval', $site->monitoring_interval) == 10 ? 'selected' : '' }}>
                                    Every 10 minutes
                                </option>

                                <option value="15" {{ old('monitoring_interval', $site->monitoring_interval) == 15 ? 'selected' : '' }}>
                                    Every 15 minutes
                                </option>

                                <option value="30" {{ old('monitoring_interval', $site->monitoring_interval) == 30 ? 'selected' : '' }}>
                                    Every 30 minutes
                                </option>

                                <option value="60" {{ old('monitoring_interval', $site->monitoring_interval) == 60 ? 'selected' : '' }}>
                                    Every 60 minutes
                                </option>
                ...
                <div class="mt-8 rounded-2xl border border-[#d8e8e6] bg-[#f6fbfa] p-5">
                    ...
                    <div class="flex items-center justify-between gap-4">
                        ...
                        <label class="relative inline-flex cursor-pointer items-center">
                            ...
                            <div class="h-7 w-12 rounded-full bg-[#cfd9d6] shadow-inner transition peer-checked:bg-[#287f86] after:absolute after:left-[3px] after:top-[3px] after:h-5 after:w-5 after:rounded-full after:bg-white after:shadow-sm after:transition-all peer-checked:after:translate-x-5">
                            </div>
                ...
                <div class="mt-6 rounded-2xl border border-[#d8e8e6] bg-[#f6fbfa] p-5">
        ...
        <div class="mt-6 flex items-center justify-center gap-2 text-xs text-[#929c98]">
            ...
            Your website monitoring settings will be updated immediately.
